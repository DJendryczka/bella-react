...
const Contact = () => {
  return (
    <div id="contact" className=" max-w-[1400px] h-[700px] mx-auto mt-20 bg-blue-50">
      <h4 className=" text-center text-3xl font-bold py-10 ">Vid förfrågningar samt offert fyll i formuler nedan</h4>
